...
def process(geração_kw):
    ...
    return total_pote_kw,total_pote_kvar,perdas_kw,\
           ...
           local_barra_min,Tensão_Barra_GER03,Pot_W_Montante_GER03,\
           Pot_KVAR_Montante_GER03,Corrente_Linha_GER03,Alarme_Corrente_Linha_GER03,\
           Quan_Barra_Sub_Tensão,Quan_Barra_Sobre_Tensão,Perdas_W_Linha_GER03,Perdas_KVAR_Linha_GER03,Pot_W_Jusante_GER03
...
for geração_kw in geração_Kw_List:
    ...
    Tensão_Barra_GER03.append(resultado_2[8])
    Pot_W_Montante_GER03.append(resultado_2[9])
    Po_KVAR_Montante_GER03.append(resultado_2[10])
    Corrente_Linha_GER03.append(resultado_2[11])
    Alarme_Corrente_Linha_GER03.append(resultado_2[12])
    Quan_Barra_Sub_Tensão.append(resultado_2[13])
    Quan_Barra_Sobre_Tensão.append(resultado_2[14])
    Perdas_W_Linha_GER03.append(resultado_2[15])
    Perdas_KVAR_Linha_GER03.append(resultado_2[16])
    Pot_W_Jusante_GER03.append(resultado_2[17])
...
DadosCKT3, grafico = plt.subplots(nrows=3, ncols=2 , sharex=True)
DadosCKT3.suptitle('Dados Gerais CKT 03', color="black")
...
DadosGER03, grafico1 = plt.subplots(nrows=2,ncols=2,sharex=True)
DadosGER03.suptitle('Dados no local de instalação do GER03')
grafico1[0,0].plot(Tabela_Perdas_Linha_GER03["Potência da G.D KW"],Tabela_Perdas_Linha_GER03["Perdas em KW"],color="red",label="Perdas em KW")
grafico1[0,1].plot(Tabela_Potência_W_Montante_Jusante_GER03["Potência da G.D KW"],Tabela_Potência_W_Montante_Jusante_GER03["Fluxo a montante em KW"],color="orange",label="Fluxo a Montade em KW")
grafico1[0,1].plot(Tabela_Potência_W_Montante_Jusante_GER03["Potência da G.D KW"],Tabela_Potência_W_Montante_Jusante_GER03["Fluxo a jusante em KW"],color="red", label="Fluxo a Jusante em KW")
grafico1[1,0].plot(Tabela_Corrente_Linha_GER03["Potência da G.D KW"],Tabela_Corrente_Linha_GER03["Módulo da Corrente"], color="black",label="Módulo da Corrente")
grafico1[1,0].axhline(600, color="purple",label="Alarme de Corrente")
grafico1[1,1].plot(Tabela_Tensão_PU_Barra_GER03["Potência da G.D KW"],Tabela_Tensão_PU_Barra_GER03["Tensão em PU da Barra do GER03 "], color="blue",label="Tensão Pu")
