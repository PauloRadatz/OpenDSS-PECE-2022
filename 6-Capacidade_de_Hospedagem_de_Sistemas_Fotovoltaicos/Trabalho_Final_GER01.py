...
def process(geração_kw):
    ...
    # Potência a jusante - Constastar que a carga não se altera
    ...
    return total_pote_kw,total_pote_kvar,perdas_kw,\
           ...
           local_barra_min,Tensão_Barra_GER01,Pot_W_Montante_GER01,\
           Pot_KVAR_Montante_GER01,Corrente_Linha_GER01,Alarme_Corrente_Linha_GER01,\
           Quan_Barra_Sub_Tensão,Quan_Barra_Sobre_Tensão,Perdas_W_Linha_GER01,Perdas_KVAR_Linha_GER01, Pot_W_Jusante_GER01
...
for geração_kw in geração_Kw_List:
    ...
    Tensão_Barra_GER01.append(resultado_2[8])
    Pot_W_Montante_GER01.append(resultado_2[9])
    Po_KVAR_Montante_GER01.append(resultado_2[10])
    Corrente_Linha_GER01.append(resultado_2[11])
    Alarme_Corrente_Linha_GER01.append(resultado_2[12])
    ...
    Pot_W_Jusante_GER01.append(resultado_2[17])
...
DadosCKT01, grafico = plt.subplots(nrows=3, ncols=2 , sharex=True)
DadosCKT01.suptitle('Dados Gerais do CKT 01', color="black")
...
grafico[0,0].set_title("Gráfico GERADOR 1")
...
grafico[1, 0].plot(Tabela_Dados_Gerais["Potência da G.D KW"], Tabela_Dados_Gerais["Perdas em KW"], color="red", label="Perdas em KW1")
grafico[1, 1].plot(Tabela_Dados_Gerais["Potência da G.D KW"], Tabela_Dados_Gerais["Perdas em KVAR"],color="red",label="Perdas em KVAR1")
grafico[2, 0].plot(Tabela_Dados_Gerais["Potência da G.D KW"], Tabela_Dados_Gerais["Tensão Máxima"],color="blue", label="Tensão Máxima1")
...
grafico[2, 1].plot(Tabela_Dados_Gerais["Potência da G.D KW"], Tabela_Dados_Gerais["Tensão Mínima"], color="black", label="Tensão Mínima1")
...
DadosGER01.suptitle('Dados no local de instalação do GER01')
